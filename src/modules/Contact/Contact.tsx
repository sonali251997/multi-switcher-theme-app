        ...
        <>
            ...
            <div className="bg-[var(--color-bg-100)]">
                <div className="p-6 max-w-7xl mx-auto">
                    {/* Title */}
                    <h1 className="text-4xl font-bold  text-[var(--color-text-100)] mb-4">Contact Page</h1>
                    ...
                    {/* Button */}
                    <button className="bg-[var(--color-primary-100)] hover:bg-blue-700 text-white font-semibold py-2 px-4 rounded mb-10">
                        Learn More
                    </button>
